...
--
-- Host: 127.0.0.1    Database: akuavida
-- ------------------------------------------------------
...
CREATE TABLE `carrito_de_compras` (
  `ID_Carrito` varchar(250) NOT NULL COMMENT 'Llave Primaria de carrito de compras',
...
CREATE TABLE `categorias` (
  `ID_Categoria` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Llave primaria de categoria',
  ...
  `Pariente` int(11) NOT NULL COMMENT 'La categoria Padre ',
...
CREATE TABLE `cuenta` (
  ...
  KEY `fk_Cuenta_Ususario1_idx` (`Ususario_idUsusario`),
  CONSTRAINT `fk_Cuenta_Ususario1` FOREIGN KEY (`Ususario_idUsusario`) REFERENCES `ususario` (`idUsusario`) ON DELETE NO ACTION ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `domicilio` (
  ...
  KEY `fk_Domicilio_Municipio1_idx` (`Municipio_idMunicipio`),
  KEY `fk_Domicilio_Cuenta1_idx` (`Cuenta_Tipo_Documento`,`Cuenta_Numero_Documento`),
  CONSTRAINT `fk_Domicilio_Cuenta1` FOREIGN KEY (`Cuenta_Tipo_Documento`, `Cuenta_Numero_Documento`) REFERENCES `cuenta` (`Tipo_Documento`, `Numero_Documento`) ON DELETE NO ACTION ON UPDATE CASCADE,
  CONSTRAINT `fk_Domicilio_Municipio1` FOREIGN KEY (`Municipio_idMunicipio`) REFERENCES `municipio` (`idMunicipio`) ON DELETE NO ACTION ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `factura` (
  `ID_Factura` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Llave primaria de factura',
  `Fecha` date DEFAULT NULL COMMENT 'Fecha y hora en que se realiza la factura',
  `Cuenta_Tipo_Documento` varchar(10) NOT NULL,
  `Cuenta_Numero_Documento` varchar(50) NOT NULL,
  PRIMARY KEY (`ID_Factura`),
  KEY `fk_Factura_Cuenta1_idx` (`Cuenta_Tipo_Documento`,`Cuenta_Numero_Documento`),
  CONSTRAINT `fk_Factura_Cuenta1` FOREIGN KEY (`Cuenta_Tipo_Documento`, `Cuenta_Numero_Documento`) REFERENCES `cuenta` (`Tipo_Documento`, `Numero_Documento`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `inventario` (
  `ID_Inventario` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Llave Primaria de inventario',
  `Cantidad` int(11) NOT NULL COMMENT 'Cantidad que hay en el inventario de productos',
  ...
  CONSTRAINT `fk_Inventario_Producto1` FOREIGN KEY (`Producto_ID_producto`) REFERENCES `producto` (`ID_producto`) ON DELETE NO ACTION ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `item` (
  ...
  `Pedido_Factura_ID_Factura` int(11) NOT NULL,
  `Cantidad` int(11) NOT NULL COMMENT 'cantidad total de Items',
  ...
  KEY `fk_Item_Pedido1_idx` (`Pedido_Factura_ID_Factura`),
  CONSTRAINT `fk_Item_Pedido1` FOREIGN KEY (`Pedido_Factura_ID_Factura`) REFERENCES `pedido` (`Factura_ID_Factura`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_Producto_has_Pedido_Producto1` FOREIGN KEY (`Producto_ID_producto`) REFERENCES `producto` (`ID_producto`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `items_del_carrito` (
  ...
  `Cantidad` int(10) unsigned zerofill NOT NULL COMMENT 'cantidad de productos que se agragan al carrito de compras',
  ...
  `Carrito_De_Compras_ID_Carrito` varchar(250) NOT NULL,
  PRIMARY KEY (`Producto_ID_producto`,`Carrito_De_Compras_ID_Carrito`),
  KEY `fk_Producto_has_Carrito_De_Compras_Producto1_idx` (`Producto_ID_producto`),
  KEY `fk_Items_del_Carrito_Carrito_De_Compras1_idx` (`Carrito_De_Compras_ID_Carrito`),
  CONSTRAINT `fk_Items_del_Carrito_Carrito_De_Compras1` FOREIGN KEY (`Carrito_De_Compras_ID_Carrito`) REFERENCES `carrito_de_compras` (`ID_Carrito`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fk_Producto_has_Carrito_De_Compras_Producto1` FOREIGN KEY (`Producto_ID_producto`) REFERENCES `producto` (`ID_producto`) ON DELETE NO ACTION ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `municipio` (
  ...
  CONSTRAINT `fk_Municipio_Departamento1` FOREIGN KEY (`Departamento_idDepartamento`) REFERENCES `departamento` (`idDepartamento`) ON DELETE NO ACTION ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `pago` (
  ...
  KEY `fk_pago_Factura1_idx` (`Factura_ID_Factura`),
  CONSTRAINT `fk_pago_Factura1` FOREIGN KEY (`Factura_ID_Factura`) REFERENCES `factura` (`ID_Factura`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `pedido` (
  `Factura_ID_Factura` int(11) NOT NULL,
  `Fecha` date DEFAULT NULL COMMENT 'Fecha y Hora en que se realiza el pedido',
  `Subtotal` float NOT NULL COMMENT 'El subtotal del pedido',
  `Total` float NOT NULL COMMENT 'El total a pagar del pedido',
  PRIMARY KEY (`Factura_ID_Factura`),
  KEY `fk_Pedido_Factura1_idx` (`Factura_ID_Factura`),
  CONSTRAINT `fk_Pedido_Factura1` FOREIGN KEY (`Factura_ID_Factura`) REFERENCES `factura` (`ID_Factura`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `producto` (
  ...
  `Imagen` longblob COMMENT 'imagen del producto jpg, png, gif',
  `Descripcion` longtext NOT NULL COMMENT 'descripcion Del Producto, y caracteristicas',
  `Cantidad` int(11) NOT NULL COMMENT 'Cantidad que hay en el inventario del producto',
  ...
  KEY `fk_Producto_Categorias1_idx` (`Categorias_ID_Categoria`),
  CONSTRAINT `fk_Producto_Categorias1` FOREIGN KEY (`Categorias_ID_Categoria`) REFERENCES `categorias` (`ID_Categoria`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `promociones` (
  ...
  KEY `fk_Promociones_Producto1_idx` (`Producto_ID_producto`),
  CONSTRAINT `fk_Promociones_Producto1` FOREIGN KEY (`Producto_ID_producto`) REFERENCES `producto` (`ID_producto`) ON DELETE NO ACTION ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2015-03-11 14:13:17
